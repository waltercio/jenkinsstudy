 ...
 */
 ...
 class SnowTranslatorMsPerformanceTest extends BaseTest {
  ...
  //  Name of each request
   ...
   //Getting timestamp for unique ids
    ...
    val scn = scenario("SnowTranslatorMsPerformanceTest")
      ...
      .exec(http(req01)
        ...
        .body(StringBody("{\"indexName\":\"snow_opstroubleticket\",\"payload\":\"{\\\"customerName\\\":\\\"QA Customer\\\",\\\"issueType\\\":\\\"CRI - Security Incident\\\",\\\"issueDescription\\\":\\\"Translator test\\\",\\\"shortDescription\\\":\\\"short test\\\"}\"}"))
        //stg - .body(StringBody("{\"indexName\":\"snow_opstroubleticket\",\"payload\":\"{\\\"customerName\\\":\\\"QA Customer\\\",\\\"issueDescription\\\":\\\"Translator test\\\",\\\"shortDescription\\\":\\\"short test\\\"}\"}"))
        .check(status.is(200))
        /**
...
/**
      ...
      .exec(http(req05)
        ...
        .body(StringBody("{\"tableName\": \"incident\",\"payload\": \"{\\\"number\\\":\\\"INCTest" + "${id}" + "\\\",\\\"customerName\\\":\\\"QA Customer\\\",\\\"issueType\\\":\\\"CRI - Security Incident\\\",\\\"issueDescription\\\":\\\"Translator test\\\",\\\"shortDescription\\\":\\\"short test\\\"}\"}"))
        .check(status.is(200))
        /**
         * Need to add valid checks here.. for now as draft I am checking only 200 in the response
         */
...
**/
    setUp(
    scn.inject(constantUsersPerSec(15).during(20))
